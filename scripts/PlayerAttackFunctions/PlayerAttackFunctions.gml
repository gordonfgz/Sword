...
function AttackSlash2() {
	...
	CalcSlashAttack2(sPlayerAttackSlashHB2);
...
function AttackShoot() {
	//Attack just started
	if (sprite_index != sPlayerAttackShoot) {
		//Set up correct animation
		sprite_index = sPlayerAttackShoot;
		localframe = 0;
		image_index = 0;
	...
	CalcShootAttack(sPlayerAttackShootHB);
