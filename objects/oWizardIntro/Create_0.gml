...
strings[5] = "You walk uneasily through the arches, freezing as you spot a solitary figure in the distance.";
strings[6] = "You:\nWhat is that?!";
strings[7] = "The purple cloaked figure stands motionless, fingers wrapped around a staff pulsing with dark, sinister energy."
strings[8] = "Excalibur?:\nThat, my dear, is the Jailer.";
strings[9] = "You:\nWhy's he the only one who's animated?";
strings[10] = "Excalibur?:\nBecause he is a wizard jailer. Wizard jailers are always animated; it's common sense.";
strings[11] = "You consider asking if Excalibur? means it's a jailer who's also a wizard, or a person who jails wizards,\nbut decide you'd better keep your mouth shut.";
...
strings[22] = "You are at a loss for words, so Excalibur? conveniently moves on."
strings[23] = "Excalibur?:\nWell then, hope to it; time's a wasting.";
strings[24] = "You silently swear vengeance on this accursed sword, and prepare yourself to fight a wizard with a fireball skill you never even knew you had.";
strings[25] = "Wow it sounds really bad when you put it that way, huh? Well have fun!";
strings[26] = ""
